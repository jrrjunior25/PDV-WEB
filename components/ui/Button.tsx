...
const Button = ({ 
  ...
  const variantStyles = {
    primary: 'bg-brand-primary text-white hover:bg-brand-secondary focus:ring-brand-light',
    secondary: 'bg-gray-200 text-text-secondary hover:bg-gray-300 focus:ring-gray-400',
    danger: 'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500',
    ghost: 'bg-transparent text-brand-primary hover:bg-brand-primary/10 focus:ring-brand-light',
  };

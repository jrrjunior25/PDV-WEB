...
import { AccountPayable, CashRegisterSession, Customer, Delivery, Product, ProductCategory, PurchaseOrder, Return, Sale, StoreCredit, Supplier, SystemSettings } from '../../shared/types';
